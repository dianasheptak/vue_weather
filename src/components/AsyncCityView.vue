<template>
    ...
    <div class="flex flex-col items-center text-white py-12">
        ...
        <hr class="border-white border-opacity-10 border w-[80%]"/>
        ...
        <div @click="removeCity" class="flex items-center gap-2 py-12 text-white cursor-pointer hover:text-red-500">
